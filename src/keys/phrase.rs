...
impl FromStr for Language {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        let language = Language::from_language_code(s)
            .ok_or(FeelessError::LanguageError(LANGUAGES.to_string()))?;
        Ok(language)
    }
}
...
impl Phrase {
    ...
    pub fn to_mnemonic(&self) -> Result<Mnemonic, FeelessError> {
    ...
    pub fn to_bip39_seed(&self, passphrase: &str) -> Result<bip39::Seed, FeelessError> {
    ...
    pub fn to_bip32_ext_key(
        ...
        account: u32,
        passphrase: &str,
    ) -> Result<ExtendedSecretKey, FeelessError> {
    ...
    pub fn to_private(&self, account: u32, passphrase: &str) -> Result<Private, FeelessError> {
    ...
    pub fn from_words(language: Language, words: &str) -> Result<Self, FeelessError> {
